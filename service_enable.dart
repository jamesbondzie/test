...
class ServiceEnabledWidget extends StatefulWidget {
  ...
  @override
  _ServiceEnabledWidgetState createState() => _ServiceEnabledWidgetState();
}
...
class _ServiceEnabledWidgetState extends State<ServiceEnabledWidget> {
  ...
  Future<void> _checkService() async {
    final bool serviceEnabledRequest = await location.serviceEnabled();
    setState(() {
      _serviceEnabled = serviceEnabledRequest;
    });
  }
